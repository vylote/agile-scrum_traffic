...
import { Filter, Download, FileSpreadsheet, FileText, Calendar, Plus } from "lucide-react";
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-[90px] flex items-center justify-between px-8 bg-transparent shrink-0 mt-2">
          ...
          <div className="flex items-center gap-5">
            <ExportButton onClick={() => alert("Mở popup tạo báo cáo nhanh...")} />
           ...
           <div className="bg-white rounded-2xl border border-gray-200 shadow-sm flex flex-col mt-2 min-h-[500px]">
              ...
              <div className="p-5 flex justify-between items-center border-b border-gray-200 bg-white rounded-t-2xl">
                <div className="flex items-center gap-4">
                  <h3 className="text-lg font-bold text-gray-900">Lịch sử xuất báo cáo</h3>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-50/50 border-b border-gray-200">
                      <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider w-24">Mã BC</th>
                      <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Tên báo cáo</th>
                      ...
                      <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Dung lượng</th>
                    ...
                    {mockReports.map((report) => (
                      <tr key={report.id} className="hover:bg-gray-50/80 transition-colors group">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="font-bold text-gray-500 text-xs">{report.id}</span>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-gray-900 text-[15px]">{report.name}</span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="text-gray-600 font-medium text-sm">{report.date}</span>
                        </td>

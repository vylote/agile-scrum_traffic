    ...
    <div className="flex flex-col min-h-screen bg-[#F2F2F7] font-sans pb-24">
      ...
      <div className="flex items-center justify-between px-7 mt-6 mb-7">
        ...
        <img 
          ...
          alt="avatar" onClick={() => navigate("/citizen/account")}
        />
      </div>
      ...
      <div className="px-6 space-y-3">
        ...
        >
          ...
          <div className="flex flex-col items-start flex-1">
            <span className="text-[#FF3B30] text-[20px] font-bold tracking-tight">SOS Khẩn cấp</span>
            <span className="text-[#8E8E93] text-[14px]">Tự động gửi vị trí ngay lập tức</span>
          </div>
          <img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/rVIdi7n1RR/bo31ab9n_expires_30_days.png" className="w-5 h-5 opacity-40" alt="arrow" />
        </button>
        ...
        >
          ...
          />
          <div className="flex flex-col items-start flex-1">
            <span className="text-black text-[20px] font-bold tracking-tight">Báo cáo chi tiết</span>
            <span className="text-[#8E8E93] text-[14px]">Mô tả sự cố để nhận hỗ trợ</span>
          </div>
          <img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/rVIdi7n1RR/jk8wo4pb_expires_30_days.png" className="w-5 h-5 opacity-40" alt="arrow" />
        </button>
      </div>
      ...
      <div className="px-6 mt-8 flex flex-col gap-3">
        ...
        <div className="w-full h-[280px] rounded-[30px] relative overflow-hidden bg-white shadow-md border border-gray-100">
          ...
          <div className="absolute top-4 left-4 right-4 bg-white/90 backdrop-blur-md py-2.5 px-5 rounded-full flex items-center gap-2 shadow-sm border border-white/50 z-10 pointer-events-none">
            ...
            <span className="text-black text-[14px] font-bold">1 đội cứu hộ gần bạn</span>
          </div>
        </div>
      </div>

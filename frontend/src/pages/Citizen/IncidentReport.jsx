...
export const IncidentReport = () => {
  ...
  const incidentTypes = [
    ...
    { id: 2, label: "Hỏng xe / Chết máy", icon: <Wrench className="w-5 h-5" /> },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F2F2F7] font-sans pb-10">
      ...
      <div className="px-6 mt-6 space-y-8">
          ...
          <div className="bg-white rounded-[24px] overflow-hidden shadow-sm border border-gray-100">
            ...
            <div className="p-4 flex justify-between items-center">
              <div className="flex flex-col">
                <span className="text-black font-bold text-[15px]">3 Cầu Giấy</span>
                <span className="text-[#8E8E93] text-[12px]">Ngọc Khánh, Đống Đa, Hà Nội</span>
              </div>
            ...
            {incidentTypes.map((type) => (
              ...
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center mr-4 ${
                  selectedType === type.label ? "bg-blue-100 text-blue-600" : "bg-gray-100 text-gray-400"
                }`}>
                  {type.icon}
                </div>
        ...
        <section className="space-y-3">
          <h3 className="text-[#727272] text-[13px] font-bold uppercase ml-4">Chi tiết bổ sung</h3>
        ...
        <div className="pt-4">
          ...
          <p className="text-center text-[12px] text-gray-400 mt-4 px-10 leading-relaxed">
            Bằng việc gửi báo cáo, vị trí của bạn sẽ được chia sẻ với đội cứu hộ gần nhất.
          </p>
        </div>
